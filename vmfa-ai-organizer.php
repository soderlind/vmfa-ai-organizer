...
// Plugin constants.
define( 'VMFA_AI_ORGANIZER_VERSION', '1.6.3' );
...
if ( class_exists( \VirtualMediaFolders\Addon\ActionSchedulerLoader::class ) ) {
	\VirtualMediaFolders\Addon\ActionSchedulerLoader::maybe_load( VMFA_AI_ORGANIZER_PATH );
}
...
function init(): void {
	...
	\Soderlind\WordPress\GitHubUpdater::init(
		github_url: 'https://github.com/soderlind/vmfa-ai-organizer',
		plugin_file: VMFA_AI_ORGANIZER_FILE,
		plugin_slug: 'vmfa-ai-organizer',
		name_regex: '/vmfa-ai-organizer\.zip/',
		branch: 'main',
	);
...
function missing_parent_notice(): void {
	...
	printf(
		...
		esc_html__(
			'Virtual Media Folders - AI Organizer requires the "Virtual Media Folders" plugin (version 2.0.0 or later) to be installed and active.',
			'vmfa-ai-organizer'
		)
	);
}
